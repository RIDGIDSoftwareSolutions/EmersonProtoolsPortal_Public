...
public abstract class JPADAO_TestBase<DAO extends JPAEntityCRUD<ET, PKT>, ET extends PrimaryKeyedEntity<PKT>, PKT extends Comparable<PKT>> {
    ...
    private final boolean primaryKeyIsAutoGenerated;
    ...
    public JPADAO_TestBase(Class<ET> entityClass,
        ...
        if (primaryKeyIsAutoGenerated && primaryKeyColumnAndFieldNames.size() != 2)
            throw new IllegalArgumentException("primaryKeyColumnAndFieldNames must be exactly 1 column/field pair if the primary key is auto-generated");
        ...
        this.primaryKeyIsAutoGenerated = primaryKeyIsAutoGenerated;
    ...
    protected final List<ET> generateTestEntities() {
        return primaryKeyIsAutoGenerated
