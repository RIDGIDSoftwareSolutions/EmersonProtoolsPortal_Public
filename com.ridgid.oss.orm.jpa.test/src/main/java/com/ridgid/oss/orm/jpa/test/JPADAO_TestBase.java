...
public abstract class JPADAO_TestBase<DAO extends JPAEntityCRUD<ET, PKT>, ET extends PrimaryKeyedEntity<PKT>, PKT extends Comparable<PKT>> {
    ...
    private final PrimaryKeyAutoGenerationType primaryKeyAutoGenerationType;
    ...
    private final List<Boolean> childCollectionPrimayKeysAutogeneratedFlags = new ArrayList<>();
    ...
    private final List<Boolean> readOnlyChildCollectionPrimayKeysAutogeneratedFlags = Collections.unmodifiableList(childCollectionPrimayKeysAutogeneratedFlags);
    ...
    private int syntheticSequence = Integer.MIN_VALUE;
    ...
    public JPADAO_TestBase(Class<ET> entityClass,
        ...
        if (primaryKeyAutoGenerationType.equals(PrimaryKeyAutoGenerationType.SEQUENCE) && primaryKeyColumnAndFieldNames.size() != 2)
            throw new IllegalArgumentException("primaryKeyColumnAndFieldNames must be exactly 1 column/field pair if the primary key is auto-generated as a Sequence");
        if (primaryKeyAutoGenerationType.equals(PrimaryKeyAutoGenerationType.IDENTITY) && primaryKeyColumnAndFieldNames.size() != 2)
            throw new IllegalArgumentException("primaryKeyColumnAndFieldNames must be exactly 1 column/field pair if the primary key is auto-generated as an Identity Column");
        if (primaryKeyAutoGenerationType.equals(PrimaryKeyAutoGenerationType.GUID) && primaryKeyColumnAndFieldNames.size() != 2)
            throw new IllegalArgumentException("primaryKeyColumnAndFieldNames must be exactly 1 column/field pair if the primary key is auto-generated as an GUID Column");
        ...
        this.primaryKeyAutoGenerationType = primaryKeyAutoGenerationType;
    ...
    void addChildCollectionMetaData(String collectionFieldName,
                                    ...
                                    boolean childCollectionPrimaryKeyAutoGenerated,
        ...
        childCollectionPrimayKeysAutogeneratedFlags.add(childCollectionPrimaryKeyAutoGenerated);
    ...
    protected final List<ET> generateTestEntities() {
        return primaryKeyAutoGenerationType.equals(PrimaryKeyAutoGenerationType.NOT_AUTOGENERATED)
                ? generateEntitiesFromPrimaryKeys(numberOfTestRecords, this::primaryKeyGenerator)
                : generateEntitiesWithAutoGeneratedPrimaryKeys(numberOfTestRecords);
    }

    protected final List<ET> generateTestEntitiesAndFillForeignKeys() {
        List<ET> rv =
                (
                        primaryKeyAutoGenerationType.equals(PrimaryKeyAutoGenerationType.NOT_AUTOGENERATED)
                                ? generateEntitiesFromPrimaryKeys(numberOfTestRecords, this::primaryKeyGenerator)
                                : generateEntitiesWithAutoGeneratedPrimaryKeys(numberOfTestRecords)
                );
        for (int i = 0; i < rv.size(); i++)
            foreignKeysUpdater(i, rv.get(i));
        return rv;
    }
    ...
    public List<Boolean> getChildCollectionPrimayKeysAutogeneratedFlags() {
        return readOnlyChildCollectionPrimayKeysAutogeneratedFlags;
    }
    ...
    public final <T2 extends PrimaryKeyedEntity<PKT2>, PKT2 extends Comparable<PKT2>>
    void setupEntitiesWithAutoGeneratedPrimaryKeys(int numberOfRecords,
                                                   Class<T2> entityClass,
                                                   Class<PKT2> primaryKeyClass,
                                                   Function<Integer, PKT2> primaryKeyGenerator) {
        setupEntitiesWithAutoGeneratedPrimaryKeys(
                numberOfRecords,
                JPAEntityHelpers.getConstructorForEntityOrThrowRuntimeException(entityClass)
        );
    }
    ...
    public final void setupEntitiesWithAutoGeneratedPrimaryKeys(int numberOfRecords) {
        setupEntitiesWithAutoGeneratedPrimaryKeys(
                numberOfRecords,
                JPAEntityHelpers.getConstructorForEntityOrThrowRuntimeException(entityClass),
                this::foreignKeysUpdater
     ...
     * @return
     */
    public final List<ET> generateEntitiesWithAutoGeneratedPrimaryKeys(int numberOfRecords) {
        return JPAEntityHelpers.generateEntitiesFromPrimaryKeys(
                numberOfRecords,
                JPAEntityHelpers.getConstructorForEntityOrThrowRuntimeException(entityClass)
        );
    ...
    private <T2 extends PrimaryKeyedEntity<PKT2>, PKT2 extends Comparable<PKT2>>
    void setupEntitiesWithAutoGeneratedPrimaryKeys(int numberOfTestRecords,
                                                   Constructor<T2> entityConstructor) {
        setupEntitiesWithAutoGeneratedPrimaryKeys(numberOfTestRecords, entityConstructor, null);
    }
    ...
    Query createNativeInsertQueryFrom(String schemaName,
        ...
        switch (primaryKeyAutoGenerationType) {
            case GUID:
            case SEQUENCE:
                Field f = FieldReflectionHelpers.getFieldOrThrowRuntimeException(entity.getClass(), primaryKeyFieldNames.get(0));
                switch (primaryKeyAutoGenerationType) {
                    case GUID:
                        FieldReflectionHelpers.setFieldValueOrThrowException(entity, f, UUID.randomUUID());
                        break;
                    case SEQUENCE:
                        FieldReflectionHelpers.setFieldValueOrThrowException(entity, f, syntheticSequence++);
                        break;
                }
                break;
            case IDENTITY:
                throw new IllegalArgumentException("IDENTITY auto-generated primary key not supported by the test framework at this time");
        }
