...
/**
 * Base interface for a Topic on the MessageBus
 */
public interface Topic
{
    ...
    /**
     * Reset the topic's MessageBus provider so that the provider is reloaded on next usage.
     */
    default void resetMessageBus() {}
