...
public class Hierarchy<PARENT_T> {
    ...
    public static class Builder<T> {
        ...
        public <CHILD_T> Builder<T> one(Function<T, CHILD_T> selector) {
        ...
        public <CHILD_T> Builder<T> many_i(Function<T, Iterable<CHILD_T>> selector) {
        ...
        public <CHILD_T> Builder<T> many_a(Function<T, CHILD_T[]> selector) {
    ...
    private static abstract class BaseNode<PARENT_T, T> implements VisitableNode<PARENT_T, T> {
        ...
        @Override
        public <CHILD_T> Node<T> one(Function<T, CHILD_T> selector,
                                     Consumer<Node<CHILD_T>> childrenSelector) {
            SingleChild<T, CHILD_T> child = new SingleChild<>(selector);
            if (childrenSelector != null) childrenSelector.accept(child);
            childNodes.add(child);
        ...
        @Override
        public <CHILD_T> Node<T> many_i(Function<T, Iterable<CHILD_T>> selector,
                                        Consumer<Node<CHILD_T>> childrenSelector) {
            IterableChild<T, CHILD_T> child = new IterableChild<>(selector);
            if (childrenSelector != null) childrenSelector.accept(child);
            childNodes.add(child);
        ...
        @Override
        public <CHILD_T> Node<T> many_a(Function<T, CHILD_T[]> selector,
                                        Consumer<Node<CHILD_T>> childrenSelector) {
            ArrayChild<T, CHILD_T> child = new ArrayChild<>(selector);
            if (childrenSelector != null) childrenSelector.accept(child);
            childNodes.add(child);
