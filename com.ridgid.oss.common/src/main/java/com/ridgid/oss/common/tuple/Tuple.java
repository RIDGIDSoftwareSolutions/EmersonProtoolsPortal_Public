...
public interface Tuple
{
    ...
    interface Tuple1<T> extends Tuple {
        ...
        default T getFirst() { return (T) getValue(0);}
    }
    ...
    interface Tuple2<T1, T2> extends Tuple1<T1> {
        ...
        @SuppressWarnings("unchecked")
        default T2 getSecond() { return (T2) getValue(1);}
    }
    ...
    interface Tuple3<T1, T2, T3> extends Tuple2<T1, T2> {
        ...
        @SuppressWarnings("unchecked")
        default T3 getThird() { return (T3) getValue(2);}
    }
    ...
    interface Tuple4<T1, T2, T3, T4> extends Tuple3<T1, T2, T3> {
        ...
        @SuppressWarnings("unchecked")
        default T4 getFourth() { return (T4) getValue(3);}
    }
    ...
    interface Tuple5<T1, T2, T3, T4, T5> extends Tuple4<T1, T2, T3, T4> {
        ...
        @SuppressWarnings("unchecked")
        default T5 getFifth() { return (T5) getValue(4);}
    }
    ...
    interface Tuple6<T1, T2, T3, T4, T5, T6> extends Tuple5<T1, T2, T3, T4, T5> {
        ...
        @SuppressWarnings("unchecked")
        default T6 getSixth() { return (T6) getValue(5);}
    }
    ...
    final class Implementation{
        ...
        static class Tuple2Impl<T1, T2> implements Tuple2<T1, T2>{
            ...
            @Override
            public Stream<Class<?>> getTypes() {
                return Stream.of(value1.getClass(), value2.getClass());
            }
        ...
        static class Tuple3Impl<T1, T2, T3> implements Tuple3<T1, T2, T3>{
            ...
            Tuple3Impl(T1 value1, T2 value2, T3 value3) {
                this.value1 = value1;
                this.value2 = value2;
                this.value3 = value3;
            }
            ...
            @Override
            public Stream<Class<?>> getTypes() {
                return Stream.of(value1.getClass(), value2.getClass(), value3.getClass());
            }
        ...
        static class Tuple4Impl<T1, T2, T3, T4> implements Tuple4<T1, T2, T3, T4>{
            ...
            Tuple4Impl(T1 value1, T2 value2, T3 value3, T4 value4) {
                this.value1 = value1;
                this.value2 = value2;
                this.value3 = value3;
                this.value4 = value4;
            ...
            @Override
            public Stream<Class<?>> getTypes() {
                return Stream.of(value1.getClass(), value2.getClass(), value3.getClass(), value4.getClass());
            }
        ...
        static class Tuple5Impl<T1, T2, T3, T4, T5> implements Tuple5<T1, T2, T3, T4, T5>{
            ...
            Tuple5Impl(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5) {
                this.value1 = value1;
                this.value2 = value2;
                this.value3 = value3;
                this.value4 = value4;
            ...
            @Override
            public Stream<Class<?>> getTypes() {
                return Stream.of(value1.getClass(), value2.getClass(), value3.getClass(), value4.getClass(), value5.getClass());
            }
        ...
        static class Tuple6Impl<T1, T2, T3, T4, T5, T6> implements Tuple6<T1, T2, T3, T4, T5, T6>{
            ...
            Tuple6Impl(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6) {
                this.value1 = value1;
                this.value2 = value2;
                this.value3 = value3;
                this.value4 = value4;
            ...
            @Override
            public Stream<Class<?>> getTypes() {
                return Stream.of(value1.getClass(), value2.getClass(), value3.getClass(), value4.getClass(), value5.getClass(), value6.getClass());
            }

            @Override
            public Stream<Object> getValues() {
                return Stream.of(value1, value2, value3, value4, value5, value6);
            }
